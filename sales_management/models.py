...
class FreeeDeals(models.Model):
    ...
    debit_amount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # 借方税額:Currency(8) False
    debit_tax_amount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # 貸方勘定科目:Text(255)
    ...
    credit_amount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # 貸方税額:Currency(8) False
    credit_tax_amount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # 摘要:Text(255) False
...
class Omron(models.Model):
    ...
    # 売上金額:Currency(8) False
    sales_amount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
...
class Payments(models.Model):
    ...
    total_collected = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    ...
    fee_percentage_rate = models.DecimalField(max_digits=19, decimal_places=2, null=True)
...
class Sales(models.Model):
    ...
    gross_retail_sales = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # TotalGrossSales:Currency(8) False
    total_gross_sales = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # TotalSalonDiscount:Currency(8) False
    total_salon_discount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # RetailDiscount:Currency(8) False
    retail_discount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # ServiceNetSales:Currency(8) False
    service_net_sales = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # RetailNetSales:Currency(8) False
    retail_net_sales = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    # TotalNetSales:Currency(8) False
    total_net_sales = models.DecimalField(max_digits=19, decimal_places=2, null=True)
...
class SalesDetails(models.Model):
    ...
    gross_sales = models.DecimalField(max_digits=19, decimal_places=2, null=True)
...
Payments.payment_id = models.ForeignKey(Sales, on_delete=models.SET_NULL, null=True, related_name='sales_payment')
Payments.sales_id = models.ForeignKey(Sales, on_delete=models.SET_NULL, null=True, related_name='sales_related')

SalesDetails.sale_id = models.ForeignKey(Sales, on_delete=models.SET_NULL, null=True)
